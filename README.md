...
- поменять версию `*.xcodeproject` на Xcode-compatible 9.3
...
- Проставить необходимые build-configuration для действий и сделать схему `shared`
- Добавить локализации при необходимости
